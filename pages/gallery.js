...
const images = [
  { original: image_1, thumbnail: thumb_1 },
  { original: image_2, thumbnail: thumb_2 },
  { original: image_3, thumbnail: thumb_3 },
  { original: image_4, thumbnail: thumb_4 },
  { original: image_5, thumbnail: thumb_5 },
  { original: image_6, thumbnail: thumb_6 },
  { original: image_7, thumbnail: thumb_7 },
  { original: image_8, thumbnail: thumb_8 },
];

const images_2 = [
  { original: image_9, thumbnail: thumb_9 },
  { original: image_10, thumbnail: thumb_10 },
  { original: image_11, thumbnail: thumb_11 },
  { original: image_12, thumbnail: thumb_12 },
];
...
const Gallery = () => {
  return (
    <div>
      <SEO
        title="Gallery"
        description="Photos of Maplewood Ceilidh Band playing at weddings and events."
      />
      <Navbar />
      <div className="page-title">Gallery</div>
      <div className="main-text">
        <p>
          Thanks to wedding photographer{' '}
          <a href="http://www.benjaminthephotographer.co.uk/" target="_blank" rel="noopener noreferrer">
            Ben Pollard
          </a>
        </p>
        <p>
          for these great photos taken at{' '}
          <a href="https://www.facebook.com/lowerdamgatefarm" target="_blank" rel="noopener noreferrer">
            Lower Damgate Farm, Ilam
          </a>
          .
        </p>
      </div>
